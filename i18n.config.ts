  ...
  messages: {
    uz: {
      ...
      hero2: {
        ...
        subtitle:
          'Biz energiya tejamkorligini oshiradigan va ekspluatatsiya xarajatlarini kamaytiradigan ilg‘or texnologiyalarni taqdim etamiz.'
      },
      about: {
        title: 'Biz haqimizda',
        description:
      ...
      counters: {
        ...
        employees: 'Mutaxassis xodimlar'
      },
      contact: {
        title: 'Biz bilan bog‘laning',
        description: 'Har qanday savolingiz bo‘lsa, bemalol yozing.',
      ...
      order: {
        ...
        messagePlaceholder: 'Izoh (ixtiyoriy)'
      },
      aboutPage: {
        title: 'Biz haqimizda',
      ...
      visionMission: {
        title: "Vizyon va Missiya",
        missionTitle: "Bizning Missiyamiz",
        missionText:
          "Bizning missiyamiz – mijozlarimizning ehtiyojlarini qondirish uchun ekologik toza, ishonchli va yuqori samarali qozon uskunalari, chiqindi moyni tozalash tizimlari, saqlash tanklari, isitish va bug‘ qozonlari hamda qayta ishlash tizimlarini taqdim etishdir. Mijozlar roziligini yuqori darajada ushlab turish uchun doimiy ravishda innovatsion va barqaror yechimlarni ishlab chiqamiz, sifat standartlarini yuqori darajada saqlaymiz va ishonchli hamkor bo‘lishga intilamiz.",
        visionTitle: "Bizning Maqsadimiz",
        visionText:
          "Bizning Maqsadimiz – sohada yetakchi o‘rinni egallash va mijozlarga eng yaxshi xizmatni ko‘rsatish orqali doimiy o‘sishga erishishdir. So‘nggi texnologiyalarni diqqat bilan kuzatib borish, innovatsion mahsulotlar ishlab chiqish va mijozlarga yo‘naltirilgan yechimlarni taklif qilish vizyonimizning asosiy qismlaridir. Bundan tashqari, ish jarayonlarimizda barqarorlik va atrof-muhitni muhofaza qilish tamoyillarini qo‘llab-quvvatlab, kelajak avlodlarga toza muhit qoldirishni maqsad qilganmiz."
      },
    },
    ru: {
      ...
      hero2: {
        ...
        subtitle:
          'Мы предлагаем передовые технологии, повышающие энергоэффективность и снижающие эксплуатационные расходы.'
      },
      about: {
        title: 'О нас',
        description:
      ...
      counters: {
        ...
        employees: 'Специалистов в штате'
      },
      contact: {
        title: 'Свяжитесь с нами',
        description: 'Если у вас есть какие-либо вопросы, не стесняйтесь писать.',
      ...
      visionMission: {
        ...
        missionText:
          "Наша миссия — удовлетворять потребности клиентов, предоставляя экологически чистые, надежные и высокоэффективные котлы, системы очистки отработанного масла, резервуары для хранения, отопительные и паровые котлы, а также системы переработки. Основные принципы нашей миссии — разрабатывать инновационные и устойчивые решения, обеспечивать высокий уровень качества и быть надежным партнёром.",
        visionTitle: "Наше Видение",
        visionText:
          "Наше видение — стать лидером отрасли и постоянно развиваться, предоставляя клиентам лучший сервис. Следить за технологическими инновациями, разрабатывать новаторские продукты и предлагать ориентированные на клиента решения — ключевые элементы нашего видения. Также мы стремимся внести вклад в более чистое будущее, соблюдая принципы устойчивого развития и защиты окружающей среды."
      },
    ...
    tr: {
      ...
      hero2: {
        ...
        subtitle:
          'Enerji verimliliğini artıran ve işletme maliyetlerini azaltan ileri teknolojiler sunuyoruz.'
      },
      about: {
        title: 'Hakkımızda',
        description:
      ...
      counters: {
        ...
        employees: 'Uzman Kadro'
      },
      contact: {
        title: 'Bizimle İletişime Geçin',
        description: 'Herhangi bir sorunuz varsa, çekinmeden yazın.',
      ...
      order: {
        ...
        messagePlaceholder: 'Mesaj (isteğe bağlı)'
      },
      aboutPage: {
        title: 'Hakkımızda',
      ...
      visionMission: {
        ...
        missionText:
          "Misyonumuz, müşterilerimize çevre dostu, güvenilir ve yüksek performanslı makina kazanları, atık yağ arıtma sistemleri, stok tankları, kalorifer kazanları, buhar kazanı geri dönüşüm sistemleri gibi ürünler sunarak onların ihtiyaçlarını karşılamaktır. Müşteri memnuniyetini en üst düzeyde tutmak için sürekli olarak yenilikçi ve sürdürülebilir çözümler geliştirmek, kalite standartlarını yüksek tutmak ve müşterilerimize güvenilir bir iş ortağı olmak misyonumuzun temel unsurlarıdır.",
        visionTitle: "Vizyonumuz",
        visionText:
          "Vizyonumuz, sektörde lider bir konuma sahip olmak ve müşterilerimize en iyi hizmeti sunarak sürekli büyümektir. Teknolojik gelişmeleri yakından takip ederek yenilikçi ürünler üretmek, sektördeki en son trendleri takip etmek ve müşteri odaklı çözümler sunmak vizyonumuzun temel bileşenleridir. Ayrıca, iş süreçlerimizde sürdürülebilirlik ve çevre koruması ilkelerini benimseyerek gelecek nesillere daha temiz bir dünya bırakmaya katkıda bulunmak da vizyonumuzun bir parçasıdır."
      },
    ...
    en: {
      ...
      hero2: {
        ...
        subtitle:
          'We provide cutting-edge technologies that improve energy efficiency and reduce operational costs.'
      },
      about: {
        title: 'About Us',
        description:
      ...
      counters: {
        ...
        employees: 'Expert Staff'
      },
      contact: {
        title: 'Contact Us',
        description: 'If you have any questions, feel free to write.',
        fullName: 'Full Name',
        email: 'Email',
      ...
      visionMission: {
        ...
        missionText:
          "Our mission is to meet our customers' needs by offering eco-friendly, reliable, and high-performance boiler systems, waste oil treatment systems, storage tanks, heating boilers, steam boilers, and recycling systems. Our core values are to provide innovative and sustainable solutions, maintain high-quality standards, and be a trustworthy partner.",
        visionTitle: "Our Vision",
        visionText:
          "Our vision is to become a leader in the industry and to grow consistently by offering the best service to our customers. Following technological advancements, developing innovative products, and providing customer-focused solutions are essential parts of our vision. We also aim to contribute to a cleaner world for future generations by embracing sustainability and environmental protection in our processes."
      },
    }
  }
}))
